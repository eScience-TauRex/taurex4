...
class SimpleCloudsContribution(Contribution):
    ...
    # The override below adds the cross-section straight to tau: the cloud is
    # optically thick below the deck, so there is no path integral at all.
    direct_accumulation = True
